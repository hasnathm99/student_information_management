		...
		<div class="row">
			<div class="col-lg-5">
				<div class="panel panel-default">
				    <div class="panel-heading"><h4>Student Exam Fees</h4></div>
				    <div class="panel-body">
				    	<form action="examfees.php" method="POST">
...
if(isset($_POST['amount']) and isset($_POST['date']) and isset($_POST['message'])){
	...
	$query="insert into exam_fees(amount,date,message) values('$amount', '$date', '$message')";
