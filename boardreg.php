		...
		<div class="row">
			<div class="col-lg-5">
				<div class="panel panel-default">
				    <div class="panel-heading"><h4>Student Board Registration</h4></div>
				    <div class="panel-body">
				    	<form action="boardreg.php" method="POST">
...
if(isset($_POST['amount']) and isset($_POST['date']) and isset($_POST['message'])){
	...
	$query="insert into student_board_registration(amount,date,message) values('$amount', '$date', '$message')";
