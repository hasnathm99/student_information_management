			...
			<div class="col-lg-5">
				<div class="panel panel-default">
				    ...
				    <div class="panel-body">
				    	<form action="other_campus_fee.php" method="POST">
...
if(isset($_POST['amount']) and isset($_POST['date']) and isset($_POST['message'])){
	...
	$query="insert into other_campus_fee(amount,date,message) values('$amount', '$date', '$message')";
